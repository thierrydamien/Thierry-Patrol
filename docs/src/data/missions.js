...
const BOSSES = {
  marauder: {
    name: "THE MARAUDER",
    hp: 460, size: 132, tint: "#ff2d55", entryY: 150,
    weakPoints: [
  ...
  sentinel: {
    name: "SKY SENTINEL",
    hp: 980, size: 150, tint: "#a855f7", entryY: 158,
    weakPoints: [
...
const MISSIONS = [
  ...
  },
  {
    ...
    waves: [
      w(0.5,  "grunt",  7, "line"),
      w(5.0,  "weaver", 6, "arc"),
      w(10.0, "weaver", 7, "tripleColumns"),
      w(15.0, "grunt",  8, "vee"),
      w(20.0, "carrier",1, "column"),
      w(23.0, "weaver", 7, "twinColumns"),
      w(28.0, "grunt",  9, "wall"),
    ],
  ...
  },
  {
    ...
    waves: [
      w(0.5,  "grunt",   7, "arc"),
      w(4.5,  "striker", 4, "line"),
      w(9.0,  "weaver",  7, "twinColumns"),
      w(13.0, "striker", 5, "vee"),
      w(18.0, "carrier", 1, "column"),
      w(21.0, "grunt",  10, "scatter"),
      w(26.0, "striker", 6, "sides"),
      w(31.0, "weaver",  9, "wall"),
    ],
    objectives: ["complete","kill90","rescueAll"],
  },
  {
    ...
    waves: [
      w(0.5,  "grunt",   8, "line"),
      w(5.0,  "brute",   3, "tripleColumns"),
      w(10.0, "striker", 5, "arc"),
      w(15.0, "brute",   4, "line"),
      w(20.0, "carrier", 1, "column"),
      w(24.0, "turret",  3, "sides"),
      w(29.0, "grunt",  10, "pincer"),
    ],
    boss: "marauder",
    objectives: ["complete","kill90","rescueAll"],
  },
  {
    ...
    waves: [
      w(0.5,  "kamikaze", 4, "arc"),
      w(4.0,  "swooper",  5, "line"),
      w(8.5,  "kamikaze", 6, "sides"),
      w(13.0, "weaver",   8, "tripleColumns"),
      w(17.5, "swooper",  7, "vee"),
      w(22.0, "carrier",  2, "twinColumns"),
      w(26.0, "kamikaze", 8, "pincer"),
      w(31.0, "swooper",  8, "scatter"),
    ],
    objectives: ["complete","kill90","rescueAll"],
  },
  {
    ...
    waves: [
      ...
      w(4.0,  "striker", 5, "line"),
      w(8.0,  "carrier", 2, "twinColumns"),
      w(13.0, "swooper", 7, "arc"),
      w(17.0, "carrier", 2, "sides"),
      w(22.0, "brute",   3, "tripleColumns", { elite: 1 }),
      w(27.0, "carrier", 3, "tripleColumns"),
      w(31.0, "grunt",  10, "wall"),
    ],
  ...
  },
  {
    ...
    waves: [
      w(0.5,  "weaver",   8, "arc"),
      w(4.5,  "striker",  6, "sides", { elite: 1 }),
      w(9.0,  "kamikaze", 7, "pincer"),
      w(13.5, "turret",   3, "tripleColumns", { elite: 1 }),
      w(18.0, "brute",    4, "vee"),
      w(23.0, "carrier",  2, "twinColumns"),
      w(27.0, "swooper",  8, "scatter", { elite: 2 }),
      w(32.0, "striker",  7, "line"),
      w(37.0, "grunt",   11, "wall"),
    ],
    objectives: ["complete","kill90","rescueAll"],
  },
  {
    ...
    waves: [
      w(0.5,  "grunt",   10, "arc"),
      w(4.5,  "swooper",  7, "vee", { elite: 1 }),
      w(9.0,  "striker",  7, "line"),
      w(13.5, "kamikaze", 8, "sides"),
      w(18.0, "brute",    4, "tripleColumns", { elite: 1 }),
      w(23.0, "carrier",  2, "twinColumns"),
      w(27.0, "turret",   4, "arc"),
      w(32.0, "weaver",  11, "wall", { elite: 2 }),
    ],
    boss: "sentinel",
    objectives: ["complete","kill90","rescueAll"],
  },
