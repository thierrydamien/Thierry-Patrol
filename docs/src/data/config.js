...
const TUNES = [
  ...
  { id:"scavenger",name:"SCAVENGER", unlockMission:14,
  ...
  { id:"ghost",    name:"GHOST", unlockMission:16,
  ...
  { id:"nova",     name:"NOVA", unlockMission:22, apex:true,
  ...
  { id:"apex",     name:"APEX", unlockMission:19, apex:true,
